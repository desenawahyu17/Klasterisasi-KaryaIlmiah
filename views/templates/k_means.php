	...
	<div class="row">
		<div class="col-md-12 col-sm-12">
			<div class="bs-callout bs-callout-primary mt-0">
				<h4>Metode <em>K-Means</em></h4>
				<p>Proses pengujian dengan menggunakan metode <em>k-means</em>.</p>
			</div>
			<div class="row">
				<!-- Alert -->
				<?php
			...
			<div class="row">
				...
				<div class="col-md-12 text-center mb-4">
					<button type="button" class="btn btn-success w-25 mx-1" data-toggle="modal" data-target="#korpusModal"><i class="fa fa-id-card"></i> Pengujian dengan <em>K-Means</em></button>
						...
						<div class="modal-dialog">
							<div class="modal-content text-left">
								<div class="modal-header">
									<h5 class="modal-title">Metode <em>K-Means</em></h5>
									<button type="button" class="close" data-dismiss="modal" aria-label="Close">
										<span aria-hidden="true">&times;</span>
									</button>
								</div>
								<form action="../controllers/kmeans_add.php" method="POST">
									<div class="modal-body px-5 py-3">
										<label class="text-muted mb-0 text-justify">Pengujian terhadap <em>model</em> dengan metode <span class="h6"><em>K-Means</em></label>
										<br />
